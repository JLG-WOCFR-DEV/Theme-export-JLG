...
require_once __DIR__ . '/class-tejlg-admin-import-page.php';
...
class TEJLG_Admin {
    ...
    /** @var TEJLG_Admin_Export_Page */
    private $export_page;

    /** @var TEJLG_Admin_Import_Page */
    private $import_page;

    /** @var TEJLG_Admin_Debug_Page */
    private $debug_page;

    public function __construct() {
        $this->export_page = new TEJLG_Admin_Export_Page();
        $this->import_page = new TEJLG_Admin_Import_Page();
        $this->debug_page  = new TEJLG_Admin_Debug_Page();
