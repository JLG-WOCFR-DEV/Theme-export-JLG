            ...
            [
                ...
                'exportAsync' => [
                    ...
                    'strings' => [
                        ...
                        'autoFailed'      => esc_html__("L'export a été interrompu automatiquement après une longue inactivité.", 'theme-export-jlg'),
                        'cancelled'       => esc_html__('Export annulé.', 'theme-export-jlg'),
                        'cancelledDetails'=> esc_html__('La tâche a été annulée avant la fin du traitement.', 'theme-export-jlg'),
