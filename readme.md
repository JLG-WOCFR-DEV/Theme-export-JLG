...
- **Sauvegarder les compositions personnalisées en JSON**, avec un mode « export portable » qui neutralise les IDs médias et les métadonnées pour limiter les dépendances à un site spécifique. L’export sérialise désormais l’extrait, les catégories, les étiquettes et les métadonnées REST (dont `viewportWidth`) afin qu’un import restaure fidèlement la composition d’origine.【F:theme-export-jlg/includes/class-tejlg-admin.php†L112-L177】【F:theme-export-jlg/includes/class-tejlg-export.php†L769-L947】【F:theme-export-jlg/includes/class-tejlg-import.php†L597-L1108】
